...
RedactorPlugins.styles = {
	init: function ()
	{
		...
		if (this.buttonGet('formatting').length)
		{
			this.buttonAddAfter('formatting','styles', this.opts.curLang.customStyles, false, dropdown);
		}
		else
		{
			this.buttonAdd('styles', this.opts.curLang.customStyles, false, dropdown);
		}

		this.buttonAwesome('styles', 'fa-magic');
	},
